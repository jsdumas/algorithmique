...
public class GainCalculTest {
	...
	private static final int GROUP_OF_TWO_PERSON = 2;
	private static final int GROUP_OF_THREE_PERSON = 3;
	...
	private static final Queue<GroupOfPerson> FOUR_GROUPS_OF_SEVERAL_PERSONS_QUEUE = new GroupQueueBuilder().with(GROUP_OF_THREE_PERSON)
			.with(GROUP_OF_ONE_PERSON).with(GROUP_OF_ONE_PERSON).with(GROUP_OF_TWO_PERSON).build();
