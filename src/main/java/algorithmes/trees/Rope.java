...
class App extends Rope {
	...
	public Rope sub(int begin, int end) {
		...
		return new App(this.left.sub(begin, this.left.length), this.right.sub(0, endr));
	}
...
class TestRope {
	public static void main(String[] args) {
		Rope r = new App(new Str("Ec"), new App(new App(new Str("oleP"), new Str("o")), new App(new App(new Str("lytech"), new Str("ni")),
				new Str("que"))));
