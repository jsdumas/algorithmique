...
class Josephus {
	...
	/*
	 * construction de la liste circulaire 1,2,...,n; l'élément renvoyé est celui contenant 1
	 */
...
class JosephusSingly {
	...
	/*
	 * construction de la liste circulaire 1,2,...,n; l'élément renvoyé est celui contenant n
	 */
