package designpatterns.practice.treeptik.runtime;

import java.util.Iterator;
import java.util.List;

import designpatterns.practice.treeptik.initobjet.Deplacer;
import designpatterns.practice.treeptik.proxy.FileDescription;
