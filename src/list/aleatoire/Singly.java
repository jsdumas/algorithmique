...
public class Singly {
	...
	/*
	 * algorithme de détection de cycle de Floyd (dit algorithme du lièvre et de la tortue)
	 */
	...
	/*
	 * tirage aléatoire dans une liste (en un seul parcours)
	 */
